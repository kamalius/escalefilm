<template>
  <footer class="px-10 py-8body-font mt-3">
    <div
    ...
    >
      <div>
        ...
        >
          <img src="/clapperboard.svg" alt="icon_escalefilm" class="w-6" />
          <span class="ml-3 text-xl">escale film</span>
        </nuxt-link>
      </div>
      <p
      ...
      >
        ...
        <a href="https://www.youtube.com/channel/UCcOEMzu58baVGunSW524T6Q">
          <svg
            id="Layer_1"
            version="1.1"
            viewBox="0 0 500 500"
            ...
            class="h-6 w-6 fill-current ml-3"
            data-v-7ac1059d=""
          >
            <g data-v-7ac1059d="">
              <linearGradient
